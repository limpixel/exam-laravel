            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{ route('backend.edit.process.portfolio', $portfolio->id) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                <div class="form-group">
                                    <div class="col-xs-12 col-sm-12 col-md-12 mb-3">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="title" placeholder="Masukkan judul..." class="form-control @error('title') is-invalid text-danger @enderror" value="{{ $portfolio->title }}">
                                            @error('title')
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" name="description" type="text">{!! $portfolio->description !!}</textarea>
                                            @error('description')
